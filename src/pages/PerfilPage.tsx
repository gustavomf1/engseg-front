...
export default function PerfilPage() {
  ...
  const concluidas = ocorrencias.filter(o => o.status === 'CONCLUIDA' || o.status === 'RESOLVIDO').length
  const pendentes = ocorrencias.filter(o => o.status !== 'CONCLUIDA' && o.status !== 'RESOLVIDO' && o.status !== 'NAO_RESOLVIDA').length
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <div className="grid grid-cols-3 gap-5">
        ...
        {/* Info card */}
        <div className="col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-4">
          <div>
