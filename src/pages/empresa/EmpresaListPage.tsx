...
export default function EmpresaListPage() {
  ...
  const empresasFiltradas = filtroTipo === 'mae'
    ? empresas.filter(e => !e.empresaMaeId)
    : filtroTipo === 'filha'
    ? empresas.filter(e => !!e.empresaMaeId)
    : empresas
                ...
                <tr key={empresa.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                      empresa.empresaMaeId ? 'bg-orange-100 text-orange-700' : 'bg-blue-100 text-blue-700'
                    }`}>
